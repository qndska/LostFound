  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          widget.title,
          style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF26117A)), // Set app bar title text color to black
        ),
        centerTitle: true,
        actions: [
          IconButton(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              SizedBox(
                  height:
                      20), // Add space between Lost/Found buttons and search field
              OptionButtonFrame(
                options: ['Lost', 'Found'],
                ...
                child: TextField(
                  decoration: InputDecoration(
                    ...
                    contentPadding: EdgeInsets.symmetric(
                        vertical: 10,
                        horizontal:
                            20), // Adjust padding for text field content
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(
                          50), // Set border radius to make it long oval
              ...
              SizedBox(
                  height: 20), // Add space between user info and contact button
            ],
          ),
        ),
      ),
